  ...
  return (
    <div className='md:w-[300px] md:min-h-[260px] p-5 bg-gray-900 rounded-2xl 
            ...
            <div className='flex justify-around'>
              <img src='htmllogo.png' className='w-8 h-8'/>
              <img src='csslogo.png' className='w-8 h-8'/>
              <img src='tailwindlogo.png' className='w-8 h-8'/>
              <img src='reduxlogo.png' className='w-8 h-8'/>
            </div>
            <div className='flex justify-around mt-3'>
              <img src='jslogo.png' className='w-8 h-8'/>
              <img src='tslogo.jpg' className='w-8 h-8'/>
              <img src='postmanlogo.png' className='w-12 h-8'/>
              <img src='reactlogo.png' className='w-8 h-8'/>
            </div>
            <div className='flex justify-around mt-3'>
