...
const Skills = () => {
  return (
    <div className='w-[350px] min-h-[250px] p-5 bg-gray-900 rounded-2xl 
            ...
            <div className='flex justify-around mt-3'>
              <img src='tflogo.png' className='w-12 h-12'/>
              <img src='javalogo.png' className='w-12 h-12'/>
              <img src='firebaselogo.jpg' className='w-12 h-12'/>
              <img src='magentologo.png' className='w-12 h-12'/>
            </div>
