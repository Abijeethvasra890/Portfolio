...
const Intro = () => {
  return (
    ...
    bg-opacity-40 border-2 border-gray-500 transform transition-transform duration-500 hover:scale-105 hover:shadow-3xl'>
        ...
        <h1 className="text-white italic text-md mt-1">⭐Passionate about turning creative ideas into functional designs.</h1>
        <h1 className="text-white italic text-md mt-1">⭐Fascinated by the potential of AI and ML to transform and enhance user experiences.</h1>
    </div>
  )
}
